...
w zależności od wybranej klasy trochę różniący się wyglądem, cechami charakterystycznymi oraz atrybutami.
...
- ściąga (+spryt)
- piwo (+hp)
- (rzadkie) zdjęcia egzaminów z tamtego roku (+wiedza, +spryt, +hp)
- (bardzo rzadkie i jednorozowo) dostęp do tuptupa (++wiedza, ++spryt, ++hp)
